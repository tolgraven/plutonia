(ns plutonia.events
  (:require
    ...
    [plutonia.blog.events]
    [plutonia.user.events]
    [plutonia.strava.events]
    [plutonia.instagram.events]
    [plutonia.chat.events]
    [plutonia.gpt.events]
    [plutonia.github.events]
    [plutonia.search.events]
    [plutonia.docs.events]
    [plutonia.listener]
    [plutonia.scroll]
    [plutonia.doc-fx]
    [plutonia.effects]
