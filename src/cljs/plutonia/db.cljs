...
(def data ; default db. Needs to be cleaned out of content already haha.
  {:state {:menu false
   ...
   :routes {:home "/"
            ...
            :blog "/blog"
            :log "log"}
   :content {:document {:title "plutonia audiovisual"
                        :description "plutonia is a collection of tools and techniques for creating and visualizing audio and visual content.
                                      ^ this was generated by a robot, but close enough! Thanks robot."
                        :base-url "plutonia.se"
                        :author "Joen plutonia"
                        :email "joen.plutonia@gmail.com"}
             :header {:text ["plutonia" ["audio" "visual"]]
                      :text-personal ["plutonia" ["" "joen"]]
             ...
             :footer [{:id "left"
                       ...
                       :logo {:src "img/tolgrav-square.png" :alt "plutonia logo"}}
                      {:id "right"
                       :links [{:name "Github" :href "https://github.com/plutonia" :icon "github"}
                               {:name "LinkedIn" :href "https://linkedin.com/in/plutonia" :icon "linkedin"}
                               {:name "Instagram" :href "https://instagram.com/plutonia" :icon "instagram"}
                               {:name "Twitter" :href "https://twitter.com/joenplutonia" :icon "twitter"}
                               {:name "Facebook" :href "https://facebook.com/plutonia" :icon "facebook"}
                               {:name "Soundcloud" :href "https://soundcloud.com/plutonia" :icon "soundcloud"}]}]
             :post-footer [{:id "left"
                            :title "Inquiries"
                           ...
                           {:id "right"
                            :title "Links"
                            :links [{:name "Github" :href "https://github.com/plutonia" :info "tolgraven"}
                                    {:name "LinkedIn" :href "https://linkedin.com/in/plutonia" :info "tolgraven"}
                                    {:name "Instagram" :href "https://instagram.com/plutonia" :info "tolgraven"}
                                    {:name "Twitter" :href "https://twitter.com/joenplutonia" :info "joentolgraven"}
                                    {:name "Facebook" :href "https://facebook.com/plutonia" :info "tolgraven"}
                                    {:name "Soundcloud" :href "https://soundcloud.com/plutonia" :info "tolgraven"}]}
                           {:id "third"
                            :title "The stack"
