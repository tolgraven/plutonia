(ns plutonia.views
  (:require
   ...
   [plutonia.ui :as ui]
   [plutonia.strava.views :as strava]
   [plutonia.gpt.views :as gpt]
   [plutonia.chat.views :as chat]
   [plutonia.github.views :as github]
   [plutonia.instagram.views :as instagram]
   [plutonia.cv.views :as cv]
   [plutonia.db :as db]
   [plutonia.views-common :as view]
